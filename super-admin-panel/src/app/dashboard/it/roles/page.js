          ...
          <div className="p-8">
            <div className="flex justify-between items-center mb-8">
              <div>
                ...
                <p className="text-blue-900 text-sm">View system roles</p>
              </div>

              <div className="bg-white rounded-lg  border px-4 py-2 text-sm flex items-center gap-2 text-blue-900 hover:bg-blue-50 transition cursor-pointer">
                <Shield size={16} />
                {roles.length} Roles
              </div>
            </div>
                  ...
                  >
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-blue-900">Role</p>
                      </div>
                    </div>
                  </div>
                ))
